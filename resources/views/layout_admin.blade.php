...
<html>
  <head>
    ...
    <link href="{{ asset('admin-LTE/css/skins/skin-yellow-light.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ route('admin') }}" class="logo">
          ...
          <span class="logo-lg">Avi<b>Report</b></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{ asset('admin-LTE/img/avatar5.png') }}" class="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                            Support Team
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{ asset('admin-LTE/img/avatar5.png') }}" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="{{ asset('admin-LTE/img/avatar5.png')}}" class="img-circle" alt="User Image" />
                    <p>
                      {{ Auth::user()->name }} - Médico Veterinario
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('granja.index') }}">
                    <i class="fa fa-home"></i> <span>Granjas</span>
                </a>
            </li>
            <li>
                <a href="#">
